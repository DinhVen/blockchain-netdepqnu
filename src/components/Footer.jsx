      ...
      >
        <div className="container mx-auto px-6 pt-24 pb-14 grid gap-10 lg:grid-cols-4 text-sm items-start">
          <div className="flex flex-col items-center text-center gap-4">
            <img
              src="/assets/logo_QNU_white.png"
              alt="Logo Đại học Quy Nhơn"
          ...
          <div className="space-y-3 lg:col-span-1">
            <p className="font-semibold text-lg uppercase tracking-wide">THÔNG TIN LIÊN HỆ</p>
            <div className="flex items-start gap-2 text-white/90 hover:text-white transition-colors duration-300">
            ...
            <div className="flex items-center gap-2 text-white/90 hover:text-white transition-colors duration-300">
              <Phone size={18} />
              <span>+84 963 297 146</span>
            </div>
          </div>

          <div className="space-y-2">
            <p className="font-semibold text-lg uppercase tracking-wide">GIỚI THIỆU</p>
            <ul className="space-y-1 text-white/85">
              <li className="hover:text-white transition-colors duration-300 cursor-pointer">QNU - Nét đẹp sinh viên</li>
              <li className="hover:text-white transition-colors duration-300 cursor-pointer">Quy trình</li>
              <li className="hover:text-white transition-colors duration-300 cursor-pointer">Tính minh bạch</li>
              <li className="hover:text-white transition-colors duration-300 cursor-pointer">Cách tham gia</li>
            </ul>
          </div>

          <div className="space-y-2">
            <p className="font-semibold text-lg uppercase tracking-wide">LIÊN KẾT</p>
            <ul className="space-y-1 text-white/85">
              <li className="hover:text-white transition-colors duration-300 cursor-pointer">Bộ Giáo dục và Đào tạo</li>
              <li className="hover:text-white transition-colors duration-300 cursor-pointer">Trang chủ QNU</li>
              <li className="hover:text-white transition-colors duration-300 cursor-pointer">Khoa Công nghệ thông tin</li>
            </ul>
          </div>
        </div>
      </div>
      <div className="bg-[#045a97] dark:bg-black text-center text-sm py-3 font-medium transition-colors duration-300">
        Copyright © 2026 Đại học Quy Nhơn - Khoa Công nghệ thông tin
      </div>
    </footer>
  );
};
