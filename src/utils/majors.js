...
export const MAJORS = [
  ...
  { code: '7140231', name: 'Sư phạm Tiếng Anh' },
  { code: '7140247', name: 'Sư phạm Khoa học tự nhiên' },
  { code: '7140249', name: 'Sư phạm Lịch sử - Địa lý' },
  { code: '7220201', name: 'Ngôn ngữ Anh' },
  { code: '7220204', name: 'Ngôn ngữ Trung Quốc' },
  { code: '7229030', name: 'Văn học' },
  { code: '7310101', name: 'Kinh tế' },
  { code: '7310205', name: 'Quản lý nhà nước' },
  { code: '7310403', name: 'Tâm lý học giáo dục' },
  { code: '7310608', name: 'Đông phương học' },
  ...
  { code: '7340301ACCA', name: 'Kế toán Định hướng ACCA' },
  ...
  { code: '7510401', name: 'Công nghệ kỹ thuật hoá học' },
  ...
  { code: '7520207', name: 'Kỹ thuật điện tử' },
  ...
  { code: '7850103', name: 'Quản lý đất đai' },
];
...
export const findMajor = (query) => {
  ...
  return MAJORS.find((m) => m.name.toLowerCase().includes(q) || m.code.toLowerCase().includes(q));
};
